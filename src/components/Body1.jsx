  ...
  return (
    <div className="text-center px-4 md:px-10 py-10">
      ...
      <div className="flex flex-wrap justify-center items-center mt-12 gap-6">
        <img src="public/notion1.png" alt="From Notion" className="h-60" />
        <img src="public/arrow.png" alt="Arrow" className="h-8 w-10 mt-10" />
        <img src="public/notion2.png" alt="To Super Site" className="h-60" />
      </div>
